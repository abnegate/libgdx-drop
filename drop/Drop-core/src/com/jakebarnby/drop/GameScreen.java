...
public class GameScreen implements Screen {
	...
	private Array<Rectangle> raindrops; // List of the raindrops that fall
	private long dropTimeGap; // Total time in game, used for controlling speed
	private float dropSpeed;
	private long lastDropTime; // Last time a raindrop was spawned

	private Texture titleImage;
	private Texture dropImage; // Cached raindrop image
	private Texture bucketImage; // Cached bucket image
	private Sound dropSound; // Cached raindrop sound
	private Music rainMusic; // Cached background rain music
	private Vector3 touchPos; // Cached last touched position

	private Rectangle bucket; // Contains the item to draw
	...
	public void show() {
		// Load images
		titleImage = new Texture(Gdx.files.internal("img/drop.png"));
